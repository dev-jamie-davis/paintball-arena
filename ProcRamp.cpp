...
// Called every frame
void AProcRamp::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void AProcRamp::PostActorCreated()
{
...
void AProcRamp::GenerateBoxMesh()
{
...
void AProcRamp::CreateBoxMesh(FVector BoxRadius, TArray<FVector>& Vertices, TArray<int32>& Triangles, TArray<FVector>& Normals, TArray<FVector2D>& UVs, TArray<FProcMeshTangent>& Tangents, TArray<FColor>& Colors)
{
	FVector BoxVerts[4];
