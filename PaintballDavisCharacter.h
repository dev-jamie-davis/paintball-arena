...
#include "PaintballDavisCharacter.generated.h"

class UInputComponent;

UCLASS(config=Game)
class APaintballDavisCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class APaintballDavisProjectile> ProjectileClass;
